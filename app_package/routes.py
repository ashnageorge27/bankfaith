...
def create():
    ...
    if form.validate_on_submit():
        ...
        users1=cust_col.find_one(query)
        if not bool(users1) :
            if form.acctype.data=='ordinary' and form.balance.data>=10000 or form.acctype.data=='priority' and form.balance.data>=50000:
                ...
                flash("Problem adding user...MINIMUM BALANCE requirement is not satisfied")
